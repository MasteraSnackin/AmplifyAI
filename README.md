...
![AmplifyAI Banner](https://img.shields.io/badge/AI-Gemini%203.5-indigo) ![React](https://img.shields.io/badge/React-19-blue) ![TypeScript](https://img.shields.io/badge/TypeScript-5.0-blue) ![License](https://img.shields.io/badge/License-MIT-green)

**AmplifyAI** is an AI-powered marketing agent designed to solve the content bottleneck for brands and events. By leveraging **Google's Gemini 3.5 Multimodal AI**, it acts as a "Senior Marketing Strategist in a Box."
